...
<p>Your choose Guess Point (12 Cards)</p>
...
$app_name = "NYHC - Guess Point (12 Cards)";
...
$init_bet = (empty($_COOKIE["pref_init_bet"]))	? 200 : $_COOKIE["pref_init_bet"] ;
$bet_up = (empty($_COOKIE["pref_bet_up"]))		? 200 : $_COOKIE["pref_bet_up"] ;
$bet_down = (empty($_COOKIE["pref_bet_down"]))	? 200 : $_COOKIE["pref_bet_down"] ;
...
case 0:
	...
	echo " $page_header
		...
		<table border=1 cellspacing=1 cellpadding=1 align=center id = 'game_table'>
			...
			<tr><td colspan = 6 align=center >$msg</td>
				  
            </tr>
			<tr align = center>
			<td colspan = 6 align = center>You Point: " . number_format($balance,0,'.',',') . "</td>
			

			<tr align = center>
			<td colspan = 5 align = center>You Bet: ". number_format($bet , 0 , '.' , '.') ."</td>
			<td><input type=\"submit\" name= \"btn_plus\" value=\" + \" id = 'game_button11'>
			<input type=\"submit\" name= \"btn_minus\" value=\" - \" id = 'game_button11'></td>
			</tr>

			<tr align = center>
     		<td><input type=\"submit\" name= \"point24_33\" value=\"24-33\" id = 'game_button1'></td>
			<td><input type=\"submit\" name= \"point34_43\" value=\"34-43\" id = 'game_button1'></td>
			<td><input type=\"submit\" name= \"point44_53\" value=\"44-53\" id = 'game_button1'></td>
    		<td><input type=\"submit\" name= \"point54_63\" value=\"54-63\" id = 'game_button1'></td>
			<td><input type=\"submit\" name= \"point64_73\" value=\"64-73\" id = 'game_button1'></td>
            <td><input type=\"submit\" name= \"point74_82\" value=\"74-82\" id = 'game_button1'></td></tr>

			<tr align = center>
            <td><input type=\"submit\" name= \"point83_92\" value=\"83-92\" id = 'game_button1'></td>
			<td><input type=\"submit\" name= \"point93_102\" value=\"93-102\" id = 'game_button1'></td>
			<td><input type=\"submit\" name= \"point103_112\" value=\"103-112\" id = 'game_button1'></td>
			<td><input type=\"submit\" name= \"point113_122\" value=\"113-122\" id = 'game_button1'></td>
			<td><input type=\"submit\" name= \"point123_132\" value=\"123-132\" id = 'game_button1'></td></tr>
			...
			<td><input type=\"submit\" name= \"btn_about\" value=\"About\" id = 'game_button1'></td></tr>
				...
				<input type=\"hidden\" name=\"c12d\" value= " . $cards[12][2] . ">    </tr>
		</table>
		</form>
		</body>";
	break;
	...
	echo "$page_header
		...
		<tr><td colspan = 10 align=center><b>$app_name</i></td></tr>
			<tr ALIGN=CENTER>
                ...
                <td> <IMG SRC=" . $card_6 .  " ALT=Card6 width = 90 height = 160></tr>
			<tr ALIGN=CENTER>
				...
				<td> <IMG SRC=" . $card_10 .  " ALT=Card10 width = 90 height = 160>
				<td> <IMG SRC=" . $card_11 .  " ALT=Card11 width = 90 height = 160>
				<td> <IMG SRC=" . $card_12 .  " ALT=Card12 width = 90 height = 160></tr>
...
case 4:
	...
	echo "$page_header
		...
		<table border=1 cellspacing=1 cellpadding=1 align=center>
			...
			<tr><td align = center colspan = 6><b>About Guess Point (12 Cards)</b></td></tr>

			<tr><td align = center colspan = 5>
			<table>
			<tr><td align = center><b>**Winning Reward**</b></td></tr>
			<tr><td>Between Point</td><td align = right>Point</td></tr>
			<tr><td>123-132</td><td align = right>120</td></tr>
			<tr><td>24-33</td><td align = right>120</td></tr>
			<tr><td>113-122</td><td align = right>100</td></tr>
			<tr><td>34-43</td><td align = right>100</td></tr>
			<tr><td>103-112</td><td align = right>80</td></tr>
            <tr><td>44-53</td><td align = right>80</td></tr>
			<tr><td>93-102</td><td align = right>60</td></tr>
			<tr><td>54-63</td><td align = right>60</td></tr>
			<tr><td>83-92</td><td align = right>40</td></tr>
            <tr><td>64-73</td><td align = right>40</td></tr>
			<tr><td>74-82</td><td align = right>20</td></tr>
...
function get_result() {
	...
	if($result2 == 0){
        if(($total_point >= 123) and ($total_point <= 132)){
			$result2 = 1;
        }
    }
    
    if($result2 == 0){
        if(($total_point >= 113) and ($total_point <= 122)){
		    $result2 = 2;
        }
    }

    if($result2 == 0){
        if(($total_point >= 103) and ($total_point <= 112)){
		    $result2 = 3;
        }
    }

    if($result2 == 0){
        if(($total_point >= 93) and ($total_point <= 102)){
		    $result2 = 4;
        }
    }

    if($result2 == 0){
        if(($total_point >= 83) and ($total_point < 92)){
		    $result2 = 5;
        }
    }

    if($result2 == 0){
        if(($total_point >= 74) and ($total_point <= 82)){
		    $result2 = 6;
        }
    }

    if($result2 == 0){
        if(($total_point >= 64) and ($total_point <= 73)){
		    $result2 = 7;
        }
    }

    if($result2 == 0){
        if(($total_point >= 54) and ($total_point <= 63)){
		    $result2 = 8;
        }
    }

	if($result2 == 0){
        if(($total_point >= 44) and ($total_point <= 53)){
		    $result2 = 9;
        }
    }

    if($result2 == 0){
        if(($total_point >= 34) and ($total_point <= 43)){
		    $result2 = 10;
        }
    }

    if($result2 == 0){
        if(($total_point >= 24) and ($total_point <= 33)){
		    $result2 = 11;
        }
    }
