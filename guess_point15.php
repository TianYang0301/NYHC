...
<p>Your choose Guess Point (15 Cards)</p>
...
<input type = "submit" name = "card_8" value = "8 Card" id = "game_button1">
...
$app_name = "NYHC - Guess Point (15 Cards)";
...
$init_bet = (empty($_COOKIE["pref_init_bet"]))	? 500 : $_COOKIE["pref_init_bet"] ;
$bet_up = (empty($_COOKIE["pref_bet_up"]))		? 500 : $_COOKIE["pref_bet_up"] ;
$bet_down = (empty($_COOKIE["pref_bet_down"]))	? 500 : $_COOKIE["pref_bet_down"] ;
    ...
    if (!empty ($_POST["point36_57"])){
		if ($step == 0) {	
			...
			if ($init == 0) {	
				...
				$c11c = (empty($_POST["cb_card"][11])) ? SelectCard() :$_POST["c11c"] ;
				$c11d = (empty($_POST["cb_card"][11])) ? SelectDeck() :$_POST["c11d"] ;
				$c11f = (empty($_POST["cb_card"][11])) ? 0 :1 ;
                $c12c = (empty($_POST["cb_card"][12])) ? SelectCard() :$_POST["c12c"] ;
				$c12d = (empty($_POST["cb_card"][12])) ? SelectDeck() :$_POST["c12d"] ;
				$c12f = (empty($_POST["cb_card"][12])) ? 0 :1 ;
				$c13c = (empty($_POST["cb_card"][13])) ? SelectCard() :$_POST["c13c"] ;
				$c13d = (empty($_POST["cb_card"][13])) ? SelectDeck() :$_POST["c13d"] ;
				$c13f = (empty($_POST["cb_card"][13])) ? 0 :1 ;
				$c14c = (empty($_POST["cb_card"][14])) ? SelectCard() :$_POST["c14c"] ;
				$c14d = (empty($_POST["cb_card"][14])) ? SelectDeck() :$_POST["c14d"] ;
				$c14f = (empty($_POST["cb_card"][14])) ? 0 :1 ;
                $c15c = (empty($_POST["cb_card"][15])) ? SelectCard() :$_POST["c15c"] ;
				$c15d = (empty($_POST["cb_card"][15])) ? SelectDeck() :$_POST["c15d"] ;
				$c15f = (empty($_POST["cb_card"][15])) ? 0 :1 ;
				...
				$cards = array (
					...
					11 => array( 1 => $c11c, 2 => $c11d, 3 => $c11f, 4 => 0),
					12 => array( 1 => $c12c, 2 => $c12d, 3 => $c12f, 4 => 0),     
					13 => array( 1 => $c13c, 2 => $c13d, 3 => $c13f, 4 => 0),
					14 => array( 1 => $c14c, 2 => $c14d, 3 => $c14f, 4 => 0),
					15 => array( 1 => $c15c, 2 => $c15d, 3 => $c15f, 4 => 0)        
				);
...
if ($random_flag) {
	...
	$cards = array (
				...
				11 => array( 1 => SelectCard(), 2 => SelectDeck(), 3 => 0, 4 => 0),
				12 => array( 1 => SelectCard(), 2 => SelectDeck(), 3 => 0, 4 => 0),
				13 => array( 1 => SelectCard(), 2 => SelectDeck(), 3 => 0, 4 => 0),
				14 => array( 1 => SelectCard(), 2 => SelectDeck(), 3 => 0, 4 => 0),
				15 => array( 1 => SelectCard(), 2 => SelectDeck(), 3 => 0, 4 => 0),
				);
}
...
case 0:
	...
	$card_11 = card_img($cards[11][1],$cards[11][2]);
	$card_12 = card_img($cards[12][1],$cards[12][2]);
	$card_13 = card_img($cards[13][1],$cards[13][2]);
	$card_14 = card_img($cards[14][1],$cards[14][2]);
	$card_15 = card_img($cards[15][1],$cards[15][2]);

	echo " $page_header
		<body>
		<form name=\"post\" action=\"$_SERVER[PHP_SELF]\" method=\"POST\">
		<table border=1 cellspacing=1 cellpadding=1 align=center id = 'game_table'>
			<tr><td colspan = 5 align=center><b>$app_name</i></td></tr>
			<tr ALIGN=CENTER>
			...
			<tr><td colspan = 5 align=center >$msg</td>
				  
            </tr>
			<tr align = center>
			<td colspan = 5 align = center>You Point: " . number_format($balance,0,'.',',') . "</td>
			

			<tr align = center>
			<td colspan = 4 align = center>You Bet: ". number_format($bet , 0 , '.' , '.') ."</td>
			<td><input type=\"submit\" name= \"btn_plus\" value=\" + \" id = 'game_button11'>
			<input type=\"submit\" name= \"btn_minus\" value=\" - \" id = 'game_button11'></td>
			</tr>

			<tr align = center>
     		<td><input type=\"submit\" name= \"point36_57\" value=\"36-57\" id = 'game_button1'></td>
			<td><input type=\"submit\" name= \"point58_67\" value=\"58-67\" id = 'game_button1'></td>
			<td><input type=\"submit\" name= \"point68_77\" value=\"68-77\" id = 'game_button1'></td>
    		<td><input type=\"submit\" name= \"point78_87\" value=\"78-87\" id = 'game_button1'></td>
			<td><input type=\"submit\" name= \"point88_97\" value=\"88-97\" id = 'game_button1'></td></tr>

			<tr align = center>
            <td><input type=\"submit\" name= \"point98_107\" value=\"98-107\" id = 'game_button1'></td>
            <td><input type=\"submit\" name= \"point108_117\" value=\"108-117\" id = 'game_button1'></td>
			<td><input type=\"submit\" name= \"point118_127\" value=\"118-127\" id = 'game_button1'></td>
			<td><input type=\"submit\" name= \"point128_137\" value=\"128-137\" id = 'game_button1'></td>
			<td><input type=\"submit\" name= \"point138_159\" value=\"138-159\" id = 'game_button1'></td></tr>
			...
			<td><input type=\"submit\" name= \"btn_about\" value=\"About\" id = 'game_button1'></td></tr>
				...
				<input type=\"hidden\" name=\"c10d\" value= " . $cards[10][2] . ">
				<input type=\"hidden\" name=\"c11c\" value= " . $cards[11][1] . ">		
				<input type=\"hidden\" name=\"c11d\" value= " . $cards[11][2] . ">		
				<input type=\"hidden\" name=\"c12c\" value= " . $cards[12][1] . ">		
				<input type=\"hidden\" name=\"c12d\" value= " . $cards[12][2] . ">
				<input type=\"hidden\" name=\"c13c\" value= " . $cards[13][1] . ">		
				<input type=\"hidden\" name=\"c13d\" value= " . $cards[13][2] . ">
				<input type=\"hidden\" name=\"c14c\" value= " . $cards[14][1] . ">		
				<input type=\"hidden\" name=\"c14d\" value= " . $cards[14][2] . ">		
				<input type=\"hidden\" name=\"c15c\" value= " . $cards[15][1] . ">		
				<input type=\"hidden\" name=\"c15d\" value= " . $cards[15][2] . ">     </tr>
		</table>
		</form>
		</body>";
	break;
	...
	echo "$page_header
		...
		<tr><td colspan = 10 align=center><b>$app_name</i></td></tr>
			<tr ALIGN=CENTER>
				...
				<td> <IMG SRC=" . $card_5 .  " ALT=Card5 width = 90 height = 160></tr>
			<tr ALIGN=CENTER>
                <td> <IMG SRC=" . $card_6 .  " ALT=Card6 width = 90 height = 160>
				<td> <IMG SRC=" . $card_7 .  " ALT=Card7 width = 90 height = 160>
				<td> <IMG SRC=" . $card_8 .  " ALT=Card8 width = 90 height = 160>
                <td> <IMG SRC=" . $card_9 .  " ALT=Card9 width = 90 height = 160>
				<td> <IMG SRC=" . $card_10 .  " ALT=Card10 width = 90 height = 160></tr>
			<tr ALIGN=CENTER>	
				<td> <IMG SRC=" . $card_11 .  " ALT=Card11 width = 90 height = 160>
				<td> <IMG SRC=" . $card_12 .  " ALT=Card12 width = 90 height = 160>
				<td> <IMG SRC=" . $card_13 .  " ALT=Card13 width = 90 height = 160>
				<td> <IMG SRC=" . $card_14 .  " ALT=Card14 width = 90 height = 160>
				<td> <IMG SRC=" . $card_15 .  " ALT=Card15 width = 90 height = 160></tr>
...
case 4:
	...
	echo "$page_header
		...
		<table border=1 cellspacing=1 cellpadding=1 align=center>
			...
			<tr><td align = center colspan = 6><b>About Guess Point (15 Cards)</b></td></tr>

			<tr><td align = center colspan = 5>
			<table>
			<tr><td align = center><b>**Winning Reward**</b></td></tr>
			<tr><td>Between Point</td><td align = right>Point</td></tr>
			<tr><td>138-159</td><td align = right>120</td></tr>
			<tr><td>36-57</td><td align = right>120</td></tr>
			<tr><td>128-137</td><td align = right>100</td></tr>
			<tr><td>58-67</td><td align = right>100</td></tr>
			<tr><td>118-127</td><td align = right>80</td></tr>
            <tr><td>68-77</td><td align = right>80</td></tr>
			<tr><td>108-117</td><td align = right>60</td></tr>
			<tr><td>78-87</td><td align = right>60</td></tr>
			<tr><td>98-107</td><td align = right>40</td></tr>
            <tr><td>88-97</td><td align = right>40</td></tr>
...
function get_result() {
	...
	if($result2 == 0){
        if(($total_point >= 138) and ($total_point <= 159)){
			$result2 = 1;
        }
    }
    
    if($result2 == 0){
        if(($total_point >= 128) and ($total_point <= 137)){
		    $result2 = 2;
        }
    }

    if($result2 == 0){
        if(($total_point >= 118) and ($total_point <= 127)){
		    $result2 = 3;
        }
    }

    if($result2 == 0){
        if(($total_point >= 108) and ($total_point <= 117)){
		    $result2 = 4;
        }
    }

    if($result2 == 0){
        if(($total_point >= 98) and ($total_point < 107)){
		    $result2 = 5;
        }
    }

    if($result2 == 0){
        if(($total_point >= 88) and ($total_point <= 97)){
		    $result2 = 6;
        }
    }

    if($result2 == 0){
        if(($total_point >= 78) and ($total_point <= 87)){
		    $result2 = 7;
        }
    }

    if($result2 == 0){
        if(($total_point >= 68) and ($total_point <= 77)){
		    $result2 = 8;
        }
    }

	if($result2 == 0){
        if(($total_point >= 58) and ($total_point <= 67)){
		    $result2 = 9;
        }
    }

    if($result2 == 0){
        if(($total_point >= 36) and ($total_point <= 57)){
		    $result2 = 10;
        }
    }
	return $result2;
...
function get_result2() {
    ...
    if($result3 == 0){
        if(($total_point == 13) or ($total_point == 15) or ($total_point == 17) or ($total_point == 19) or
		   ...
		   ($total_point == 109) or ($total_point == 111) or ($total_point == 113) or ($total_point == 115) or
		   ($total_point == 117) or ($total_point == 119) or ($total_point == 121) or ($total_point == 123) or
           ($total_point == 125) or ($total_point == 127) or ($total_point == 129) or ($total_point == 131) or
           ($total_point == 133) or ($total_point == 135) or ($total_point == 137) or ($total_point == 139) or
		   ($total_point == 141) or ($total_point == 143) or ($total_point == 145) or ($total_point == 147) or
		   ($total_point == 149) or ($total_point == 151) or ($total_point == 153) or ($total_point == 155) or
		   ($total_point == 157) or ($total_point == 159) or ($total_point == 161) ){
		    $result3 = 6;
        }
    }
    ...
    if($result3 == 0){
        if(($total_point == 4) or ($total_point == 6) or ($total_point == 8) or ($total_point == 10) or
		   ...
		   ($total_point == 108) or ($total_point == 110) or ($total_point == 112) or ($total_point == 114) or
		   ($total_point == 116) or ($total_point == 118) or ($total_point == 120) or ($total_point == 122) or
		   ($total_point == 124) or ($total_point == 126) or ($total_point == 128) or ($total_point == 130) or
           ($total_point == 132) or ($total_point == 134) or ($total_point == 136) or ($total_point == 138) or
           ($total_point == 140) or ($total_point == 142) or ($total_point == 144) or ($total_point == 146) or
		   ($total_point == 148) or ($total_point == 150) or ($total_point == 152) or ($total_point == 154) or
		   ($total_point == 156) or ($total_point == 158) or ($total_point == 160)){
		    $result3 = 7;
        }
    }
