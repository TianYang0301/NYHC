...
<head>
	<title>Display New Font Style</title>
...
<tr><td>You New Font Style:</td></tr>
<tr><td>New Font Color Hex: <?php echo $GameRGB; ?></td></tr>
<tr><td>New Font Color: <input type = "color" id = "t001" name = "favcolor" value = <?php echo $GameRGB; ?>></td></tr>
<tr><td>Now Font Style: <?php echo $GameFont; ?></td></tr>
</table>

<a href="change_font.php"><input type = "button" value = "Confirm" id = "game_button1"></a>
